    ...
    <div className="page-enter">
      ...
      <section style={{ padding: '80px 48px', background: 'var(--ink)', borderTop: '1.5px solid oklch(0.2 0.01 30)' }} className="rsp-px">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 1, border: '1px solid oklch(0.2 0.01 30)', borderRadius: 4, overflow: 'hidden' }} className="rsp-3col">
          {[
            ...
            <div
              key={card.num}
              style={{ padding: '40px 36px', background: 'oklch(0.1 0.01 30)', borderRight: '1px solid oklch(0.18 0.01 30)', transition: 'background 0.2s' }}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 16 }} className="rsp-1col">
          ...
          <div style={{ display: 'grid', gridTemplateRows: '1fr 1fr', gap: 16 }}>
            {[
              ...
              <div
                key={item.label}
                style={{ position: 'relative', borderRadius: 4, overflow: 'hidden', cursor: 'pointer', ...imgPlaceholder(item.hue, item.sat) }}
                onClick={() => router.push('/shop')}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }} className="rsp-2col">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }} className="rsp-2col">
            {[
              ...
              <div
                key={pledge.label}
                style={{ padding: '24px', border: '1.5px solid var(--border)', borderRadius: 4, transition: 'border-color 0.2s, box-shadow 0.2s' }}
      ...
      <section style={{ padding: '80px 48px', borderTop: '1.5px solid var(--border)', borderBottom: '1.5px solid var(--border)' }} className="rsp-px">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6,1fr)', gap: 8 }} className="rsp-6col">
          {[
            { hue: 27, sat: 0.05, size: 'Jacket · M' },
            { hue: 220, sat: 0.03, size: 'Knit · L' },
            { hue: 150, sat: 0.02, size: 'Shirt · XL' },
            { hue: 60,  sat: 0.03, size: 'Parka · S' },
            { hue: 27,  sat: 0.03, size: 'Tee · M' },
            { hue: 200, sat: 0.04, size: 'Knit · XS' },
          ].map((item, i) => (
            <div
              key={i}
              style={{ position: 'relative', aspectRatio: '1', borderRadius: 3, overflow: 'hidden', cursor: 'pointer', ...imgPlaceholder(item.hue, item.sat) }}
